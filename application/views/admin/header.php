...
<!-- Mirrored from demos.creative-tim.com/material-dashboard-pro/examples/dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 22 Feb 2017 17:07:58 GMT -->
<head>
    <meta charset="utf-8" />
...
<body>
    <div class="wrapper">
        <div class="sidebar" data-active-color="green" data-background-color="white" data-image="<?= base_url('assetsadmin/img/sidebar-1.jpg')?>">
            <!--
    ...
    -->
            ...
            <div class="sidebar-wrapper">
                <div class="user">
                    <div class="photo">
                        <img src="<?=base_url('assetsadmin/img/faces/avatar.jpg')?>" />
                    </div>
                    <div class="info">
